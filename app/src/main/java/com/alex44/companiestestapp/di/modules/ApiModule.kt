...
import com.alex44.companiestestapp.common.model.api.ApiStrings.Companion.RETROFIT_BASE_URL
...
class ApiModule {
    ...
    @Provides
    fun dataSource(retrofit: Retrofit) : IDataSource = retrofit.create(IDataSource::class.java)
